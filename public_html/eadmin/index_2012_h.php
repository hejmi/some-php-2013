...
if (isset($_GET['orders'])) {
	...
	while ($row = mysql_fetch_array($result)) {
		...
		if ($f_available == 1 && $lt_available != 1) echo ' | <a target="_blank" href="?showorder&status=5&id='.$row['id'].'&cats=FT">Skriv ut allt</a>';
		if ($f_available == 1 && $lt_available == 1 ) echo ' | <a target="_blank" href="?showorder&status=3&id='.$row['id'].'&cats=FT">Skriv ut fröer</a>';
		if ($lt_available == 1) echo ' | <a target="_blank" href="?showorder&status=5&id='.$row['id'].'&cats=L">Skriv ut lökar</a>';
		if ($lt_available == 1 && $f_available == 1) echo ' | <a target="_blank" href="?showorder&status=5&id='.$row['id'].'">Skriv ut allt</a>';
